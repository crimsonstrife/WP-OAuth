...
$_SESSION['WPOA']['PROVIDER'] = 'Bungie.net "Destiny"';
define('HTTP_UTIL', get_option('wpoa_http_util'));
define('CLIENT_ENABLED', get_option('wpoa_bungienet_api_enabled'));
define('CLIENT_ID', get_option('wpoa_bungienet_api_id'));
define('CLIENT_SECRET', get_option('wpoa_bungienet_api_secret'));
define('REDIRECT_URI', rtrim(site_url(), '/') . '/');
define('SCOPE', get_option('wpoa_bungienet_scope')); // PROVIDER SPECIFIC: "user" is the minimum scope required to get the user's id from Github
define('URL_AUTH', get_option('wpoa_bungienet_url_auth'));
define('URL_TOKEN', get_option('wpoa_bungienet_url_token'));
define('URL_USER', get_option('wpoa_bungienet_url_user'));
